...
// This JSON file was generated by running: node seed.js
// It contains { content, embedding } objects for all resume chunks.
const require = createRequire(import.meta.url);
const KNOWLEDGE_BASE = require('./data/embeddings.json');
